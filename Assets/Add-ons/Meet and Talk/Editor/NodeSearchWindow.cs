...
namespace MEET_AND_TALK
{
    public class NodeSearchWindow : ScriptableObject, ISearchWindowProvider
    {
            ...
            List<SearchTreeEntry> tree = new List<SearchTreeEntry>
        {
            ...
            AddNodeSearch("Start Node",new StartNode(),"d_Animation.Play"),
            AddNodeSearch("Dialogue Node",new DialogueNode(),"d_UnityEditor.HierarchyWindow"),
            AddNodeSearch("Choice Node",new DialogueChoiceNode(),"d_TreeEditor.Distribution"),
            AddNodeSearch("End Node",new EndNode(),"d_winbtn_win_close_a@2x"),

            //new SearchTreeGroupEntry(new GUIContent("Special",EditorGUIUtility.FindTexture("d_Favorite Icon")),1),

            //AddNodeSearch("IF Node",new IFNode(),"d_BuildSettings.Broadcom"),
        };
